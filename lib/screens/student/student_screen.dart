                        ...
                        suffixIcon: Consumer<PlanManager>(
                          builder: (_,planManager,__){
                            return IconButton(
                                ...
                                onPressed: ()async{
                                  final text = await showDialog(context: context,
                                      builder: (_)=>ChooseDialog(
                                        titulo: "Planos Cadastradas",
                                        names: planManager.names,
                                      )
                                  );
                                  student.quantityMonths = planManager.quantity(text);
                                  plan.text = text;
                                }
                            );
                          },
                    ...
                    TextFormField(
                      ...
                      validator: (time){
                        ...
                        if(time.isEmpty){
                          ...
                          if(aux[0].length != 2 || int.parse(aux[0])>23 || int.parse(aux[0])<0){
                            return 'Horario inválido e a hora deve ter com dois digitos.';
                          }else if(aux[1].length != 2 || int.parse(aux[1])>=60 || int.parse(aux[1])<0){
